...
const PlantCard: React.FC<PlantCardProps> = ({ plant }) => {
  ...
  return (
    <Link href={`/plant/${encodeURIComponent(plant.name)}`} className="block group">
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:scale-105 border border-gray-100 h-full flex flex-col relative">
